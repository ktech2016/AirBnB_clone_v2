...
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/HeIXi8ScHQblpfCfm1c_zQ "explain to anyone"),  **without the help of Google**:
